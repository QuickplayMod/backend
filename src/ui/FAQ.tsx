export function FAQ() {
    return (
        <div>
            ...
            <h3 aria-label="Frequently Asked Questions" class="text-white text-xl">How does Quickplay work?</h3>
            ...
            <h3 aria-label="Frequently Asked Questions" class="text-white text-xl">Quickplay says I'm not connected
                to
                Hypixel, but I am. What gives?</h3>
            ...
            <h3 aria-label="Frequently Asked Questions" class="text-white text-xl">Is Quickplay allowed on Hypixel?</h3>
            <p class="text-white mb-7">Quickplay has been safely used by players on Hypixel for nearly a decade. While
            ...
            <h3 aria-label="Frequently Asked Questions" class="text-white text-xl">Can I add custom buttons/keybinds
                for my own commands?</h3>
            ...
            <h3 aria-label="Frequently Asked Questions" class="text-white text-xl">Does this mod work on other
                Minecraft servers?</h3>
            <p class="text-white mb-7">Currently, Quickplay only supports the Hypixel Network. Quickplay is not
                ...
                on <a class="underline text-teal-500" href="https://discord.gg/AWThmaVJJv">Discord</a>. You are also welcome
                to fork the <a class="underline text-teal-500" href="https://github.com/quickplaymod">GitHub repositories</a> to
