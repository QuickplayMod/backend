        ...
        <div>
            ...
            <div class="xl:text-center">
                ...
                <p class="text-white mb-5 xl:w-[500px] inline-block">Navigate the Hypixel Network quickly through an
                    intuitive interface, allowing you
                    to warp to any location on the network at the click of a button</p>
            </div>
            <div class="aspect-video bg-neutral-700 text-center mb-8 text-white">
            ...
            <div class="xl:text-center">
                ...
                <p class="text-white mb-5 xl:w-[500px] inline-block">Claim your Hypixel Daily Rewards directly in Minecraft, without having to open your browser.</p>
            </div>
            <div class="aspect-video bg-neutral-700 text-center mb-8 text-white">
                Placeholder for preview
            </div>
